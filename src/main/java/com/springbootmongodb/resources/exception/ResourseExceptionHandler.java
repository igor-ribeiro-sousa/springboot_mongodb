package com.springbootmongodb.resources.exception;
...
public class ResourseExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotDFound(ObjectNotFoundException e, HttpServletRequest request) {
